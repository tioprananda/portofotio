<template>
  <div id="app" class="bg-primary font-inter">
    ...
    <!-- navbar -->
    <header class="bg-transparent py-2 lg:py-0 absolute w-full flex items-center z-10 transition ease-in-out duration-500 scroll-smooth fixed z-[9999]" :class="{navbarFixed : showNavbar}">
      <div class="container">
      ...
      <div class="container">
        <div class="flex flex-wrap">
          ...
          <div class="w-full self-center ">
            ...
            <h3 class="text-text mb-4 text-base text-justify mt-28 transition ease-in-out duration-[1000ms]  lg:h-32" ref="home" :class="paraHome">Hello, I'm a front-end developer who loves to create my own world through programming. I love to create modular code and easy to maintain code, and documented in the form of comments that makes it easier for other teams to manage. <br>
            </h3>
            <div class="flex justify-center my-11  transition ease-in-out duration-[1000ms] lg:fixed -bottom-[105px] left-[520px] z-20" ref="home" :class="paraHome">
              ...
              <div class="px-auto lg:mt-[260px] xl:mt-[300px] flex items-center justify-start my-3 gap-2 transition ease-in-out duration-[1000ms]" ref="home" :class="paraHome">
                        <!-- foto -->
                        <img src="./assets/profil.jpg" alt="" class="w-16 h-16 rounded-full grayscale">
                        <div class="flex flex-wrap w-full lg:w-[80%] justify-start  gap-2">  
                          <!-- github -->
                            <div class="w-32 sm:w-60 lg:w-40 block ">
                              <a href="https://github.com/tioprananda" target="_blank" class="text-white flex gap-2 p-1">
                                  ...
                                  <p class="text-sm font-light text-center m-auto">GitHub</p>
                            ...
                            <!-- facebokk -->
                            <div class="w-32 sm:w-60 lg:w-40 block ">
                              <a href="https://www.facebook.com/tio.prananda.5" target="_blank" class="text-white p-1 flex gap-2 mt-1">
                                ...
                                <p class="text-sm font-light text-center m-auto">Facebook</p>
                                <svg fill="none" width="17" stroke="currentColor" viewBox="0 0 12 12" aria-hidden="true" class="stroke-current"><path d="M10.976 1.193A.314.314 0 0010.687 1H6.312a.313.313 0 000 .625h3.62L5.467 6.091a.313.313 0 00.443.442l4.466-4.466v3.62a.313.313 0 00.625 0V1.313a.328.328 0 00-.024-.119z"></path><path d="M3.5 1v.625H2.25a.625.625 0 00-.625.625v7.5c0 .345.28.625.625.625h7.5c.345 0 .625-.28.625-.625V8.5H11v1.875c0 .345-.28.625-.625.625h-8.75A.625.625 0 011 10.375v-8.75C1 1.28 1.28 1 1.625 1H3.5z"></path></svg>
                            </a>
                            </div>
                            <!-- whatasp -->
                            <div class="w-32 sm:w-60 lg:w-40 block ">
                              ...
                              <p class="text-xs text-light m-auto text-text">0887 4250 5356</p>
                              </div>
                            </div>
                            <!-- email -->
                            <div class="w-32 sm:w-60 lg:w-40 block xl:-mt-1">
                              <div class="flex gap-2 p-1">
                                <p class="text-[10px] sm:text-sm text-light m-auto text-text">prananda.tio@gmail.com</p>
                              </div>
                            </div>
                       </div>
              </div>
